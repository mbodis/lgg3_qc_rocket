...
public class AccelerometerViewRt extends SurfaceView implements Callback {
	...
	public AccelerometerViewRt(Context context) {
		super(context);
		// TODO Auto-generated method stub
	}

	public AccelerometerViewRt(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public AccelerometerViewRt(Context context, AttributeSet attrs, int defStyle) {
				...
				try {
					...
					if (c != null) {
						synchronized (this.surfaceHolder) {
							AccelerometerViewRt.this.myDraw(c);
						}
					}
				} finally {
					if (c != null)
